class Item
{
    constructor(name, desc, type)
    {
        this.name = name;
        this.desc = desc;
        this.type = type; //`consumable` or `held`
    }
...
class Repair_Pack extends Item
{
    constructor()
    {
        super("Repair Pack", "Revives a Kodial", "consumable");
    }
}
...
class Laser extends Item
{
    constructor()
    {
        super("Laser", "Gives a Kodial the ability to use laser attacks", "held");
    }
}
...
class Scope extends Item
{
    constructor()
    {
        super("Scope", "Increases critical chance", "held");
    }
}
